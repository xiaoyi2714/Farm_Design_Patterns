...
public class FarmManager {
	...
	public boolean giveFertilizer(int fieldIndex, Class cls)
	{
		...
		if (plantToGive.getPresentGrowth() >= plantToGive.getMaxGrowth()) {
			System.out.println("Fail to give fertilizer. Plant is already mature.");
			return false;
		}
		...
		System.out.println("Give "+cls.getSimpleName() + "to the plant ("+plantToGive.getName()+") on No."+fieldIndex+
				" field, grow "+FertilizerGrowthParser.FertilizerToGrowth(cls)+" points, present growth point: "+plantToGive.getPresentGrowth()+
